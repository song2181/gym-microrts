...
if __name__ == "__main__":
    ...
    with profile(
            ...
            on_trace_ready=torch.profiler.tensorboard_trace_handler('log/gridnet'),
            record_shapes=True,
        ...
        if True:
            ...
            for step in range(0, args.num_steps):
                ...
                with record_function("rollout_inference"):
                    with torch.no_grad():
                ...
                with record_function("rollout_action_preparation"):
                ...
                with record_function("rollout_env_step"):
                    try:
