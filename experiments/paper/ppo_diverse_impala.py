...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-envs", type=int, default=24, help="the number of parallel game environment")
    parser.add_argument("--num-steps", type=int, default=512, help="the number of steps per game environment")
